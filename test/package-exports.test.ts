...
describe('SDK package exports', () => {
  ...
  it('exports from /config subpath', async () => {
    const config = await import('@wifi-aware/squad-sdk/config');
  ...
  it('exports from /resolution subpath', async () => {
    const resolution = await import('@wifi-aware/squad-sdk/resolution');
    expect(resolution.resolveSquad).toBeDefined();
  });

  it('exports from /parsers subpath', async () => {
    const parsers = await import('@wifi-aware/squad-sdk/parsers');
  ...
  it('exports from /types subpath', async () => {
    ...
    const types = await import('@wifi-aware/squad-sdk/types');
    expect(types).toBeDefined();
  });

  it('exports from /agents subpath', async () => {
    const agents = await import('@wifi-aware/squad-sdk/agents');
    expect(agents).toBeDefined();
  });

  it('exports from /skills subpath', async () => {
    const skills = await import('@wifi-aware/squad-sdk/skills');
    expect(skills).toBeDefined();
  });

  it('exports from /tools subpath', async () => {
    const tools = await import('@wifi-aware/squad-sdk/tools');
