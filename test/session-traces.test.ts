...
vi.mock('@wifi-aware/squad-sdk/runtime/otel-metrics', async (importOriginal) => {
  const orig = await importOriginal<typeof import('@wifi-aware/squad-sdk/runtime/otel-metrics')>();
  return {
    ...orig,
...
} from '@wifi-aware/squad-sdk/runtime/otel-metrics';
