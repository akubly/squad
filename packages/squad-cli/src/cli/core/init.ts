...
import { initSquad as sdkInitSquad, cleanupOrphanInitPrompt, ensurePersonalSquadDir, resolveGlobalSquadPath, resolvePersonalSquadDir, clearResolveSquadCache, type InitOptions } from '@wifi-aware/squad-sdk';
...
function showDeprecationWarning(): void {
  ...
  console.log(`${YELLOW}    Run 'npx @wifi-aware/squad-cli upgrade --migrate-directory' to migrate to .squad/${RESET}`);
