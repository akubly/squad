...
export function getInstallInstructions(env: CopilotEnvironment): InstallStep[] {
  switch (env) {
    case 'cli':
      return [
        { description: 'Install the Squad SDK globally', command: 'npm install -g @wifi-aware/squad' },
    ...
    case 'vscode':
      return [
        { description: 'Install Squad SDK as a project dependency', command: 'npm install @wifi-aware/squad' },
    ...
    case 'web':
      return [
        { description: 'Install Squad SDK in the Codespace', command: 'npm install @wifi-aware/squad' },
    ...
    default:
      return [
        ...
        { description: 'Install the Squad SDK', command: 'npm install @wifi-aware/squad' },
        { description: 'Initialise a new Squad project', command: 'npx create-squad' },
      ];
  }
}
